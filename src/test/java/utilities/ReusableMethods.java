...
public class ReusableMethods {
    ...
    public static void tarihSecme(){
        Actions actions = new Actions(Driver.getDriver());
        List<WebElement> tarihler = Driver.getDriver().findElements(By.xpath("//*[@class=\"p-datepicker-day-cell\"]"));
        actions.click(tarihler.get(5)).perform();
    }
